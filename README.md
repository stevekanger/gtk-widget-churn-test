...
Update: Recently found out that commenting out adding a css class in `tab.c` at the end in `gwc_tab_new` may stop the memory increases. Seems they may have some sort of cache for styles that never gets released.
