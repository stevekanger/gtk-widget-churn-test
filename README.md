...
This behavior only happens when you click on the buttons being destroyed. There is a control button on the left which triggers the exact same updating of the buttons. When you use the control button memory is steady. When using the other buttons memory steadily increases. You may need to rapidly press buttons to see anything meaningful but it happens.
