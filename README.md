...
Recently found out that commenting out adding a css class to the tab may stop the memory increases. Seems they may have some sort of cache for styles that never gets released under specific circumstances.
